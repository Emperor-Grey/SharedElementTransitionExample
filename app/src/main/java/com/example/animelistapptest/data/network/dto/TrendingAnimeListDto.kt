package com.example.animelistapptest.data.network.dto

import com.example.animelistapptest.domain.model.AnimeData
import com.example.animelistapptest.domain.model.Attributes
import com.example.animelistapptest.domain.model.CoverImage
import com.example.animelistapptest.domain.model.PosterImage
import com.example.animelistapptest.domain.model.Titles

data class TrendingAnimeListDto(
    val data: List<AnimeDataDto>
) {
    fun toModel(): List<AnimeData> = data.map { it.toModel() }
}
...
data class AnimeDataDto(
    ...
    fun toModel(): AnimeData = AnimeData(
        id = id, attributes = attributes.toModel()
    )
}
