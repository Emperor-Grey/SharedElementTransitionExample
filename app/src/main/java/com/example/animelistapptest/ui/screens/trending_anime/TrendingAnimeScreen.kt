...
import com.example.animelistapptest.ui.screens.trending_anime.composable.AnimeCard
        ...
        AnimatedContent(
            ...
            if (isEmpty) {
                ...
                LazyColumn(
                    ...
                    items(items = animeData) { anime: AnimeData ->
                        AnimeCard(
                            anime = anime, onClick = {
...
@Preview
@Composable
private fun TrendingAnimeScreenPrev() {
